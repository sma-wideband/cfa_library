...
for i=1:2^n_inputs,
    ...
    reuse_block(blk, ['delay_i', num2str(i-1)], 'xbsIndex_r4/Delay',...
        ...
        'Latency', num2str(delays_i(i)+overall_delay));
    ...
    reuse_block(blk, ['delay_q', num2str(i-1)], 'xbsIndex_r4/Delay',...
        ...
        'Latency', num2str(delays_q(i)+overall_delay));
...
% Add overall_latency to line up output lags
