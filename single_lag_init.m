...
for i=0:2^n_inputs-1,
    ...
    reuse_block(blk, ['mult', num2str(i)], 'xbsMath_r4/Mult',...
...
for i=1:2^n_inputs,
    ...
    reuse_block(blk, ['delay_i', num2str(i-1)], 'xbsBasic_r4/Delay',...
    ...
    reuse_block(blk, ['delay_q', num2str(i-1)], 'xbsBasic_r4/Delay',...
